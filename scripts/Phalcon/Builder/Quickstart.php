...
use Phalcon\Builder\Quickstart\Cli;
use Phalcon\Builder\Quickstart\Micro;
use Phalcon\Builder\Quickstart\Simple;
use Phalcon\Builder\Quickstart\Modules;
...
class Quickstart extends Component
{
    ...
    /**
     * Current Quickstart Type
     * @var string
     */
    private $currentType = self::TYPE_SIMPLE;

    /**
     * Available Quickstart Types
     * @var array
     */
    private $_types = [
